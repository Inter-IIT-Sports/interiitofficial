...
const cardData = [
  {
    color: '#060010',
    title: 'FluidGlass Logo',
    description: 'Immersive glass-like animation for the hero section',
    label: 'Hero',
  ...
  },
  {
    ...
    description: 'Track time left for Inter IITM Sports 2025',
    label: 'Timer',
    logo: '/images/clock-icon.png'
  },
  {
    color: '#060010',
    title: 'Participating IITs',
    description: 'View the institutes competing this year',
    label: 'Competition',
    logo: '/images/iits.png'
  },
  {
    color: '#060010',
    title: 'Committees',
    description: 'Know about the organizing teams',
    label: 'Team',
  ...
  },
  {
    ...
    description: 'Messages from our leaders',
    label: 'Leadership',
    logo: '/images/dean.png'
  }
];
