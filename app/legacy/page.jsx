  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Inter IIT Sports Meet Legacy - A Legacy Through Time" />
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <div
          ...
          style={{ backgroundImage: "url('/images/legacy.png')" }} // ✅ fixed path
        >
          {/* Black Overlay */}
        ...
        <div className="bg-gray-100 py-2">
          <div className="container mx-auto px-4">
            <ul className="flex space-x-2 text-sm">
              <li><a href="javascript:void(0);" className="text-gray-600 hover:text-gray-800">Home</a></li>
              <li className="text-gray-400">/</li>
              <li>A Legacy Through Time: Inter IIT Sports Meet Over the Years</li>
            </ul>
          </div>
        </div>
